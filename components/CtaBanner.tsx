    ...
    <section className="relative">
      ...
      <div className="relative z-10 min-h-[400px] md:min-h-[600px] lg:min-h-[800px] flex items-start pt-16">
        <div className="container-width px-8 w-full">
          <div className="max-w-4xl ml-auto text-white text-right">
            <h2 className="text-[45px] lg:text-[65px] font-serif font-[400] leading-tight mb-8 md:mb-0">
              Spend less time worrying<br />
              and more time living
            </h2>
            <div className="flex flex-col items-end gap-4 mt-8 pb-12 md:pb-0">
              <Button 
              ...
              <a 
                ...
                className="flex items-center justify-center gap-2 text-lg hover:text-orange transition-colors"
              >
